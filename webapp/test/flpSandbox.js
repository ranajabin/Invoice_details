		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#northwindinvoicesnorthwindodatainvoicesproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwindinvoicesnorthwindodatainvoicesproject-display": {
								"semanticObject": "northwindinvoicesnorthwindodatainvoicesproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwindinvoices.northwindodatainvoicesproject",
									"url": sap.ui.require.toUrl("northwindinvoices/northwindodatainvoicesproject")
								}
							}
						}
					}
